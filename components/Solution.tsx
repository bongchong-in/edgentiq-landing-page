      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 flex flex-col md:flex-row items-center justify-center gap-8 lg:gap-16">
          ...
          <div className="w-full md:w-2/5 text-center md:text-right">
            <h3 className="text-2xl font-lora text-brand-charcoal">Attract & Win Customers</h3>
          ...
          <div className="w-full md:w-2/5 text-center md:text-left">
            <h3 className="text-2xl font-lora text-brand-charcoal">Save Time & Run Smarter</h3>
